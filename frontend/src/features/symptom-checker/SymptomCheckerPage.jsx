...
export const SymptomCheckerPage = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-slate-800">AI Symptom Evaluator</h1>
        <p className="text-sm text-slate-500">Describe physical anomalies for real-time triage guidance.</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-1 h-fit">
          <CardHeader>
            ...
            <p className="text-xs text-slate-400">Please provide precise metrics about your condition.</p>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex flex-col gap-1.5 w-full">
                ...
                <input
                  ...
                  min="1"
                  max="10"
                  className="w-full h-2 bg-slate-100 rounded-lg appearance-none cursor-pointer accent-brand-500 focus:outline-none"
                  {...register('severity')}
                />
              ...
              <div className="flex flex-col gap-1.5 w-full">
                ...
                <select
                  id="duration"
                  className="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-white/50 focus:bg-white text-slate-800 transition-all duration-200 outline-none text-sm focus:border-brand-500"
                  {...register('duration')}
                >
        ...
        <div className="lg:col-span-2 space-y-6">
          {mutation.isIdle && (
            <div className="flex min-h-[300px] flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-white p-8 text-center shadow-premium">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-slate-50 text-slate-400 mb-4 animate-bounce">
                <Bot size={24} />
              </div>
              <h3 className="text-md font-bold text-slate-800">Waiting for Form Submission</h3>
          ...
          {mutation.isPending && (
            <div className="flex min-h-[300px] flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-white p-8 text-center shadow-premium">
              <div className="h-10 w-10 animate-spin rounded-full border-4 border-slate-100 border-t-brand-500 mb-4" />
              <h3 className="text-md font-bold text-slate-800">Gemini LLM Processing...</h3>
              <p className="mt-1 text-sm text-slate-500 max-w-sm">
          ...
          {mutation.isError && (
            <div className="flex min-h-[300px] flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-white p-8 text-center shadow-premium">
              ...
              <h3 className="text-md font-bold text-slate-800">Triage Evaluation Failed</h3>
              <p className="mt-1 text-sm text-slate-500 max-w-sm">
            ...
            <Card>
              <CardHeader className="flex-row justify-between items-center pb-4 border-b border-slate-50 mb-6">
                <div>
                  ...
                  <p className="text-xs text-slate-400">Generated dynamically by Gemini 1.5</p>
                </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 rounded-xl border border-slate-100">
                    <span className="text-xs text-slate-400 font-semibold block">Confidence Level</span>
                    <span className="text-xl font-bold text-slate-800">{mutation.data.confidence}%</span>
                  </div>
                  <div className="p-4 rounded-xl border border-slate-100">
                    <span className="text-xs text-slate-400 font-semibold block">Identified Domain</span>
                    <span className="text-xl font-bold text-slate-800">{mutation.data.domain}</span>
                  </div>
                </div>
